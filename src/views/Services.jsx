    ...
    >
      ...
      >
        ...
        <div className="">
          ...
          <div style={{border:"4px solid red"}} className="mt-8 flex md:flex-row justify-between flex-col md:items-stretch items-center ">
            {projectCard.map((el) => (
              <motion.div
                initial="hidden"
                whileInView={"visible"}
              ...
              >
                <div 
                // style={{ width: "100%", heigth: "70%",border:"1 px solid red" }}
                >
                  <img
                    src={el.img}
                    alt=""
                    style={{ width: "40%", heigth: "40%",margin:"auto" }}
                  />
                </div>
                <h4 className="text-xl font-bold mt-4">{el.title}</h4>
